...
export default function Diagram() {
  return (
    <div className="px-6 mb-6 2xl:container">
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
            ...
            <div>
              ...
              <div className="mt-2 flex justify-center gap-4">
                <h3 className="text-3xl font-bold text-gray-700">77%</h3>
        ...
        <div>
          <div className="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
            <h5 className="text-xl text-gray-700">Class Test Result</h5>
            <div className="my-8">
              <h1 className="text-5xl font-bold text-gray-800">64.5%</h1>
              <span className="text-gray-500">Compared to last week 17%</span>
            </div>
            <svg
              className="w-full"
              viewBox="0 0 218 69"
        ...
        <div>
            <div className="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                ...
                <path d="M23.5776 18.4198H25.5424V22.8407H23.5776V18.4198ZM30.4545 16.455H32.4193V22.8407H30.4545V16.455ZM27.0161 13.5078H28.9809V22.8407H27.0161V13.5078Z" fill="#6A6A9F"/><defs>
                ...
                <div className="mt-6">
                    <h5 className="text-xl text-gray-700 text-center">Next Exam</h5>
                    <div className="mt-2 flex justify-center gap-4">
                        <h3 className="text-3xl font-bold text-gray-700">After 32 Days</h3>
                    </div>
